...
@ApiResponse(
        responseCode = "415",
        description = "Tipo de conteúdo enviado não suportado",
        content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErroResponse.class), examples = @ExampleObject(value = SwaggerResponseExamples.ERRO_415))
)
